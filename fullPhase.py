...
exTTtrials = [i for i in trialsList if int(i['ID']) in range(2,17,2)] # 8 TT examples
exNONtrials = [i for i in trialsList if int(i['ID']) in range(18,33,2)] # NON examples
...
with open('999'+'_TTwb.csv','wb') as resultsFile:
    Rwriter=csv.DictWriter(resultsFile, fieldnames=headers)
    Rwriter.writeheader()
    core.wait(2)
